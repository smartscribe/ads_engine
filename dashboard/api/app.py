...
# ---------------------------------------------------------------------------
# Image Feedback — style notes loop (from Alex's harness)
# ---------------------------------------------------------------------------
...
async def submit_image_feedback(fb: ImageFeedback):
    ...
    Processed by Claude, updates style notes for future generations."""
    processor = _get_feedback_processor()
    visual_style = None
    strategy_name = None
    taxonomy = None
    asset_path = None
...
async def like_image(like: ImageLike):
    """Like a generated image — saves as positive reference, updates style notes."""
    processor = _get_feedback_processor()
    visual_style = None
    asset_path = None
    taxonomy = None
...
async def get_style_notes():
    ...
    processor = _get_feedback_processor()
    return processor.get_all_notes()
